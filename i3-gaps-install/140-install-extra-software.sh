...
# core applications
# sudo apt install -y i3status i3lock
...
# sudo apt install -y lxappearance qt4-qtconfig
...
#sudo apt-get install  -y pasystray pacman paprefs pavumeter pulseaudio-module-zeroconf
